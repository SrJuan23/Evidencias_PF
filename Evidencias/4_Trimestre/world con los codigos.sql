...
select Name, ifnull(indepyear,"no tiene")
from country 
...
select language as lenguaje,concat('%',percentage) AS Porcentaje_hablantes,
case when isOfficial = 'T' then concat(language,'es un idioma oficial')
...
select name as nombre_pais, indepyear as año_independecia from country where indepyear > '1800' order by indepyear asc ;
...
select max(length(name)) as maximo from city;

select name as nombre_ciudad, length(name) as cantidad from city where length(name) = (select max(length(name)) as maximo from city);

select upper(name) as nombre_pais from country order by name asc;

select lower(name) as nombre_pais from country order by name asc;

select left(name, 1) as nombre_pais from country order by name asc;

select upper(left(name, 1)) as letra, count(*) as grupos from country
group by letra;

select name as ciudad, population as población 
from city
where population between 100000 and 200000
order by population asc;

select name, lifeExpectancy from country where lifeExpectancy between 30 and 50 order by lifeExpectancy asc;

select name, lifeExpectancy from country where lifeExpectancy >= 70 order by lifeExpectancy asc;

select min(population) as población from city;

select name as ciudad, concat(population,'  Habitantes') as menor_población from city where population = (select min(population) from city);

select name as ciudad, concat(population,'  Habitantes') as menor_población from city order by population asc limit 5;

select max(gnp) as máximo_GNP from country;

select name as país, concat('$ ',format(gnp, 2)) as GNP from country where gnp = (select max(gnp) as máximo_GNP from country);

select name as país, concat('$ ',format(GNP, 2)) as valor from country order by GNP desc limit 5;

select count(population) as población from city where population between 50 and 1000;

select name as ciudad, population as población from city where population between 50 and 1000 order by population;

select name as pais, continent, region from country where region = 'Caribbean' order by name;

select region, count(*) as paises from country
group by region
order by region;
...
select count(*) as total_paises from country where region like 'm%';

select region as region_m, count(*) as total_paises from country where region like 'm%'
group by region
order by region;

select name, indepYear from country where indepYear between 1900 and 2000 order by indepyear asc;

select count(*) as cant_paises from country where indepYear between 1900 and 2000;

select name as país, governmentform as forma_de_gobierno from country where governmentform like '%monarchy%' order by name;
